...
As a little introduction we can cover the example in the book <deep learning in R> by François Chollet with J. J. Allaire  
...
To remain completely objective here we can consult the `forecast` package:  
...
![](../../static/Pictures/Tony-Stark-Puts-On-The-Iron-Man-Suit-Gif.gif)
