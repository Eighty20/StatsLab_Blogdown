---
title: "An R4DS Summary: Visualise and Transform Your Data"
author: "Louis Becker"
date: 2018-12-21
output:
  blogdown::html_page:
    toc: true
slug: r4ds_visualise_and_transform
categories:
  - R
tags:
  - R_For_Data_Science
...
So you have your data, and it is now in R. You might even already have it in a [tidy](http://vita.had.co.nz/papers/tidy-data.html) format. Now what? Explore your data. But how? That is where this post comes in. This post summarises the [Data Visualisation](https://r4ds.had.co.nz/data-visualisation.html) and [Data Transformation](https://r4ds.had.co.nz/transform.html) chapters from [R For Data Science](https://r4ds.had.co.nz/). But why? Because sometimes we forget what's available in packages we use daily. This post is meant to serve as a let-me-scroll-trough-quickly version of the above mentioned chapters if you need a quick reference for manipulating or visualising your data.

# Let's Get Started

First, we install/load the relevant packages by installing the [tidyverse](https://www.tidyverse.org/) library. This "package" effectively contains all packages developed by *the* [Hadley Wickham](http://hadley.nz/) that relate to the *tidy data* way of thinking. This post focuses on specific libraries, but we install and load the whole `tidyverse` anyway:
